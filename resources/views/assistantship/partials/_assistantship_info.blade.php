<div class="panel panel-primary">
  	<div class="panel-heading clearfix">
  		<div class="panel-title pull-left" style="padding-top: 4px;">
  				<a data-toggle="collapse" href="#collapse_assist_partial{{ $assist_count }}">{{ $assist->student->full_name . ' - ' . $assist->position . ' - ' . $assist->semester->full_name}}</a>
  		</div>
  		
  		@if($allowChanges)
  		{!! Form::open(['method' => 'DELETE', 'route' => ['assistantship.delete', $assist], 'class' => 'form-horizontal', 'onsubmit' => 'return ConfirmDelete()']) !!}
      		<div class="btn-group pull-right">
      			<a href="{{ url('/assistantship/' . $assist->id) }}" class="btn btn-default btn-sm" data-toggle="tooltip" title="Edit"><span class="glyphicon glyphicon-edit"></span></a>
  	...
  	<div id="collapse_assist_partial{{ $assist_count }}" class="panel-collapse collapse }}">
